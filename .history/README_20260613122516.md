...
**The premise: a Claude Code power user should be able to switch between this extension and Claude Code and lose nothing.** Anything `claude` can do headlessly, you can do here — wrapped in a UI that's genuinely nicer than a TTY, without ever dropping to a second-class subset.
